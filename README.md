# BlackBattleship – Projeto de Testes de Caixa Preta
...
## Product Backlog – Jogo de Batalha Naval (papergames.io/en/battleship)

| ID | User Story | Prioridade |
|----|-----------|------------|
| US1 | Como jogador, quero aceder à página principal do jogo para poder começar a jogar. | Alta |
| US2 | Como jogador, quero introduzir um nickname para me identificar nas partidas. | Alta |
| US3 | Como jogador, quero criar uma nova partida para poder desafiar um amigo. | Alta |
| US4 | Como jogador, quero jogar contra um robô para praticar sem precisar de um adversário humano. | Alta |
| US5 | Como jogador, quero receber um link de convite para partilhar com o meu adversário. | Média |
...
| US8 | Como jogador, quero ver as regras do jogo para perceber como jogar. | Média |
...
| US13 | Como jogador, quero escolher o nível de dificuldade do robô para adaptar o desafio à minha experiência. | Média |
